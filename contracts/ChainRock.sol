...
contract ChainRock is ERC721Enumerable, Ownable {
    //  _price is the price of one Chain Rock NFT
    uint256 constant public _price = 0.01 ether;

    // Max number of Chain Rock that can ever exist
    ...
    /**
      ...
      */
    constructor (address whitelistContract) ERC721("Chain Rock", "CR") {
